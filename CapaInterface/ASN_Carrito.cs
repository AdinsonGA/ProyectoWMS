...
{
    public class ASN_Carrito
    {
        string wcodcia = DatosGenerales.codcia;
        string wcd = "50001";
        string winterface = "DEV_CAR";
        ...
        public void GenerarInterfaceNC_carrito()
        {
            bool exito = false;
        ...
        private bool ObtieneData()
        {
            ...
            // CABECERA
            string sql = "USP_WMS_Obt_Nota_Credito_Carrito"; // FALTA
        ...
        private bool Genera_FileTXT()
        {
            ...
            fileTXTc = Path.Combine(Crear_Carpetas.WORK, "ISH_DEV_CAR_" + fechor);
            fileTXTd = Path.Combine(Crear_Carpetas.WORK, "ISL_DEV_CAR_" + fechor);
        ...
        private bool Actualiza_Flag_Data()
        {
            ...
            if (dt_cab != null && dt_cab.Rows.Count > 0)
            {
                ...
                string sql_upd = "UPDATE BD_ECOMMERCE.dbo.NOTA_CREDITO SET FLAG_WMS=1 WHERE ltrim(rtrim(Not_Id)) IN (" + cade + ")"; // FALTA
                ...
                try
                {
                    using (SqlConnection cn = new SqlConnection(Conexion.conexion))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand(sql_upd, cn))
                        {
                            ...
                            LogUtil.Graba_Log(winterface, winterface + " : Se actualizó : " + Convert.ToString(dt_cab.Rows.Count) + " NOTA DE CREDITOS - [ECOMMERCE]", false, "");
                        }
