...
namespace CapaDatos
{
    public class ValidaCaracteres
    {
        public static string Numeros_Letras(string strIn)
        {
            ...
            strIn = strIn.ToString().Trim().Replace("¾", "");
            strIn = strIn.ToString().Trim().Replace("@", "a");
            strIn = strIn.ToString().Trim().Replace(",", "");
            strIn = strIn.ToString().Trim().Replace(".", "");
            strIn = strIn.ToString().Trim().Replace("!", "");
            strIn = strIn.ToString().Trim().Replace("*", "");
            ...
            strIn = strIn.ToString().Trim().Replace("<", "");
            strIn = strIn.ToString().Trim().Replace(">", "");
            strIn = strIn.ToString().Trim().Replace("ª", "");
            strIn = strIn.ToString().Trim().Replace("º", "");
            strIn = strIn.ToString().Trim().Replace("|", "");
            strIn = strIn.ToString().Trim().Replace("ü", "");
            strIn = strIn.ToString().Trim().Replace("~", "");
            strIn = strIn.ToString().Trim().Replace("€", "");
            strIn = strIn.ToString().Trim().Replace("¬", "");
            strIn = strIn.ToString().Trim().Replace("'", "");
            strIn = strIn.ToString().Trim().Replace("''", "");
            strIn = strIn.ToString().Trim().Replace("£", "");
            strIn = strIn.ToString().Trim().Replace("ø", "");
            strIn = strIn.ToString().Trim().Replace("_", "");
            strIn = strIn.ToString().Trim().Replace("§", "");
            strIn = strIn.ToString().Trim().Replace("¥", "N");
            strIn = strIn.ToString().Trim().Replace("¤", "n");
